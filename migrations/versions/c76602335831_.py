...
Revision ID: c76602335831
Revises: 
Create Date: 2018-05-30 13:32:20.194396
...
def upgrade():
    ...
    op.create_table('questionnaire_scale',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['scale_id'], ['questionnaire_scale.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade():
    ...
    op.drop_table('questionnaire_scale')
